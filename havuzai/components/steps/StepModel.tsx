...
const MODELS = [
  {
    ...
    name:  "RELAX",
    sub:   "Organik & Aile",
    desc:  "Yumuşak oval hatlar, doğal görünüm. Çocuklu aileler ve rahat kullanım için ideal.",
    tag:   "En Popüler",
  ...
  },
  {
    ...
    name:  "ROMA",
    sub:   "Klasik & Prestij",
    desc:  "Dikdörtgen geometrik tasarım. Modern mimariye ve villa bahçelerine mükemmel uyum.",
    tag:   "Premium",
